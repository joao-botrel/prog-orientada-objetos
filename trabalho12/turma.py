...
class LimiteConsultaTurma(tk.Toplevel):
    def __init__(self, controle):
        ...
        self.frameButton.pack()
        self.labelMatricula = tk.Label(self.frameCodigo, text="Codigo da turma: ")
...
class CtrlTurma():       
    ...
    def consultaTurma(self):
        self.limiteConsulta = LimiteConsultaTurma(self)
    ...
    def consultHandler (self, event):
        ...
        if aux == 0:
            self.limiteConsulta.mostraJanela("Erro!", "Turma não achada ou código inexistente")
