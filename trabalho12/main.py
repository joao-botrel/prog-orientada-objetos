...
class LimitePrincipal():
    def __init__(self, root, controle):
        ...
        self.estudanteMenu.add_command(
            label="Consulta", command=self.controle.consultaEstudantes)
        ...
        self.discipMenu.add_command(
            label="Consulta", command=self.controle.consultaDisciplina)
        ...
        self.turmaMenu.add_command(
            label="Consulta", command=self.controle.consultaTurma)
